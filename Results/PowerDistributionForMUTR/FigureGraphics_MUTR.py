...
"""
Place this python script in the same or higher directory as the xlsx spreadsheet you want to read
"""
...
if __name__ == '__main__':
    draw_core_diagram_ppf(xlsx_filepath=f"{os.getcwd()}/PowerDistribution_MUTR_params.xlsx")