...
c
{{fe_id}}01  {{mat_ss}}     {{dens_ss}}     312300 -312301 -311302          imp:n=1 u={{fe_id}}  $ Lower 
{{fe_id}}02  {{mat_water}}  {{dens_water}}     312300 -312301  311302 -311306  imp:n=1 u={{fe_id}}  $ 
{{fe_id}}03  {{mat_ss}}     {{dens_ss}}     312301 -312302 -311305          imp:n=1 u={{fe_id}}  $ Bottom 
{{fe_id}}04  {{mat_water}}  {{dens_water}}     312301 -312306  311305 -311306  imp:n=1 u={{fe_id}}  $ 
{{fe_id}}05  {{mat_graphite}}  {{dens_graphite}}     312302 -312303 -311304          imp:n=1 u={{fe_id}}  
{{fe_id}}06  {{mat_ss}}    {{dens_ss}}     312302 -312305  311304 -311305  imp:n=1 u={{fe_id}}  $ Fuel 
{{fe_id}}07  {{mat_zr}}    {{dens_zr}} 312303 -312304 -311301          imp:n=1 u={{fe_id}}  $ Zirc pin
{{fe_id}}08  {{mat_fe_id}} {{dens_fe_id}} 312303 -302303  311301 -311304   imp:n=1 u={{fe_id}} $ Fuel 
{{fe_id}}09  {{mat_fe_id}} {{dens_fe_id}} 302303 -302306  311301 -311304   imp:n=1 u={{fe_id}} $ Fuel 
{{fe_id}}10  {{mat_fe_id}} {{dens_fe_id}} 302306 -302309  311301 -311304   imp:n=1 u={{fe_id}} $ Fuel 
{{fe_id}}11  {{mat_fe_id}} {{dens_fe_id}} 302309 -302312  311301 -311304   imp:n=1 u={{fe_id}} $ Fuel 
{{fe_id}}12  {{mat_fe_id}} {{dens_fe_id}} 302312 -312304  311301 -311304   imp:n=1 u={{fe_id}} $ Fuel 
{{fe_id}}13  {{mat_graphite}}  {{dens_graphite}}     312304 -312305 -311304          imp:n=1 u={{fe_id}}  
{{fe_id}}14  {{mat_ss}}     {{dens_ss}}     312305 -312306 -311305          imp:n=1 u={{fe_id}}  $ SS 
{{fe_id}}15  {{mat_ss}}     {{dens_ss}}     312306 -312307 -311303          imp:n=1 u={{fe_id}}  $ 
{{fe_id}}16  {{mat_water}}  {{dens_water}}    312306 -312307  311303 -311306  imp:n=1 u={{fe_id}}  $ 
{{fe_id}}17  {{mat_ss}}     {{dens_ss}}     312307 -312308 -311302          imp:n=1 u={{fe_id}}  $ Fuel 
{{fe_id}}18  {{mat_water}}  {{dens_water}}     312307 -312308  311302 -311306  imp:n=1 u={{fe_id}}  $ 
{{fe_id}}19  {{mat_water}}  {{dens_water}}     312308 -312309 -311306          imp:n=1 u={{fe_id}}  $ 
c
c
c
